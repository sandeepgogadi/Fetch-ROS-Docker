...
PICKLE_FILE = '/catkin_ws/src/Fetch-ROS-Docker/map_annotator/src/map_annotator/map_annotated.p'
map_list_data = {}
current_amcl = None
...
def main():
    ...
    #target_pose_pub = rospy.Publisher('/move_base/goal', geometry_msgs.msg.PoseStamped, queue_size=10)

    amcl_sub = rospy.Subscriber(
        '/amcl_pose', geometry_msgs.msg.PoseWithCovarianceStamped, amcl_callback)
    argv = rospy.myargv()
    while True:
